resource "aws_cloudwatch_event_target" "target" {
  ...
  dynamic "batch_target" {
    for_each = [for target in var.batch_target: {
  ...
  dynamic "ecs_target" {
    for_each = [for target in var.ecs_target: {
  ...
  dynamic "input_transformer" {
    for_each = [for input in var.input_transformer: {
  ...
  dynamic "kinesis_target" {
    for_each = [for target in var.kinesis_target: {
  ...
  dynamic "run_command_targets" {
    for_each = [for target in var.run_command_targets: {
      key = target.key
  ...
  dynamic "sqs_target" {
    for_each = [for target in var.sqs_target: {
