module "lambda_function" {
  ...
  # Required
  dead_letter_queue_target_arn = var.function_dead_letter_target_type == "SQS" ? module.dead_letter_queue.resource.arn : module.dead_letter_topic.resource.arn
...
module "role" {
  ...
  policy_statements = concat(var.iam_role_policy_statements, [
    ...
    },
    {
      ...
      "Resource" : ["${var.function_dead_letter_target_type == "SQS" ? module.dead_letter_queue.resource.arn : module.dead_letter_topic.resource.arn}"]
    }
    ],
