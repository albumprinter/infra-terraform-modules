...
module "api_gateway_resource" {
  ...
  # Required
  rest_api_id = module.api_gateway_rest_api.resource.id
  parent_id = module.api_gateway_rest_api.resource.root_resource_id
...
module "api_gateway_method" {
  ...
  # Required
  rest_api_id = module.api_gateway_rest_api.resource.id
  resource_id = var.api_gateway_resource_path_part != null ? module.api_gateway_resource.resource.id : module.api_gateway_rest_api.resource.root_resource_id
...
module "api_gateway_integration" {
  ...
  rest_api_id = module.api_gateway_rest_api.resource.id
  resource_id = var.api_gateway_resource_path_part != null ? module.api_gateway_resource.resource.id : module.api_gateway_rest_api.resource.root_resource_id
  http_method = module.api_gateway_method.resource.http_method
...
module "api_gateway_deployment" {
  ...
  description = "${var.api_gateway_deployment_description} - Integration Type: ${module.api_gateway_integration.resource.type}"
